...
# Input fields (mapping user input to "Yes" or "No" instead of 0 or 1)
...
# Map categorical features to the corresponding binary values used during training
input_data = pd.DataFrame({
    ...
    # Mapping categorical columns to one-hot encoded dummy variables
